  ...
  return (
    <Box w="100%">
      ...
      <Box p="2rem" w="100%">
        ...
        <SimpleGrid columns={{ base: 1, md: 2, lg: 4 }} spacing="1rem" mb="2rem" w="100%">
          {scans.map(scan => (
            <Box key={scan.id} textAlign="center" display="flex" flexDirection="column" justifyContent="space-between">
              <Image src={scan.src} alt={scan.label} borderRadius="md" objectFit="cover" width="100%" height="50vh" />
        ...
        <SimpleGrid columns={{ base: 1, md: 2, lg: 4 }} spacing="1rem" mb="2rem" w="100%">
          {backImages.map(image => (
            <Box key={image.id} textAlign="center">
              <Image src={image.src} alt={image.label} borderRadius="md" height="50vh" width="100%" />
